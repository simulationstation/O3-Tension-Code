...
On the $N_{\rm ev}=36$ GWTC-3 sample, the production configuration yields
\begin{equation}
\Delta\LPD_{\rm tot}\simeq +3.03,\qquad \exp(\Delta\LPD_{\rm tot})\approx 20,
\end{equation}
which indicates a statistically interesting preference for the propagation phenomenology over the internal GR baseline
under the PPD construction. A key diagnostic is a sky-rotation null: we randomly rotate each event's sky localization
...
\midrule
Real data (production) & $\Delta\LPD_{\rm tot}\simeq +3.03$ \\
...
GR-systematics matrix (9 variants, 128 reps/variant) & all variant maxima $\le +0.678$ (none near real-data $+3.03$) \\
...
(Eq.~4). The vertical black line marks $\Delta\LPD=0$; the dashed orange line marks the real-data value
...
$\Delta\LPD_{\rm tot}\simeq +3.03$ under a joint logmeanexp score. Sky-rotation and spectral/sky mechanism controls localize the
...
the real-data value far outside the calibrated GR-truth ensemble under the injection-generator assumptions. The completed
...
\href{https://doi.org/10.5281/zenodo.18510138}{doi:10.5281/zenodo.18510138}. All figures in this Letter are generated from the
archived scripts and artifact manifests.
