...
null batteries remain non-decisive in that setup, so this is at most a weak directional consistency hint. Second, an
independent strong-lens time-delay holdout (H0LiCOW/TDCOSMO public chains) remains mildly BH/GR-favoring in this implementation:
across a 13-configuration KDE nuisance suite, $\Delta\LPD_{\rm MG-BH}$ has mean $-0.498$ and range $[-0.646,-0.474]$ with
$P(\Delta\LPD>0)=0$. We therefore treat these ancillary probes as useful external stress checks, but not decisive model selectors
at current data volume and calibration depth.
...
\href{https://doi.org/10.5281/zenodo.18510138}{doi:10.5281/zenodo.18510138}. Core external sources used in this Letter include
